  ...
  ({ className, type, ...props }, ref) => {
    return (
      <InputPrimitive
        ...
        data-slot="input"
        className={cn(
          "flex h-[40px] w-full min-w-0 max-w-full rounded-[7px] border border-transparent bg-white/15 px-4 py-2 text-[12px] text-[#E0E0E0] outline-none transition-colors",
