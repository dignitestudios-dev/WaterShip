...
export const DashboardHeader = () => {
  ...
  return (
    <header suppressHydrationWarning className="w-full h-[115px] bg-white shadow-[0px_0px_30px_rgba(255,255,255,0.15)] flex items-center justify-between px-6 lg:px-[130px] z-50 relative">
      {/* Left: Logo */}
      <div 
      ...
      {hasToken && (
        <div className="flex items-center gap-[15px]">
          ...
          >
            <Bell className="w-5 h-5 text-[#034593]" fill="currentColor" />
